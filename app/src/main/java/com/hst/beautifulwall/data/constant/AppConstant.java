package com.hst.beautifulwall.data.constant;
...
public class AppConstant {
    ...
    public static final String SAVE_TO = "FIRE WALL";
    ...
    public static final int BUNDLE_KEY_HOME_INDEX = 10;
    ...
    public static final String JSON_KEY_GIFS = "gifs";
    public static final String JSON_KEY_IMAGES = "images";
    public static final String JSON_KEY_YES = "yes";
